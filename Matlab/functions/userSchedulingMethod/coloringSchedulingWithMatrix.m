function params = coloringSchedulingWithMatrix(params, info)
    ...
    while(flag && count)
        ...
        for combi = combinations
            ...
            value = Matrix(U1,U2) / K;
            adjacencyMatrix(combi(1),combi(2)) = value;
        end
