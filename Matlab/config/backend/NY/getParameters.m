function params = getParameters()
    ...
    params.infra.BS.latitude = 40.726967;
    params.infra.BS.longitude = -74.207621;
    ...
    params.infra.RS.configFile = "./config/RSInitNewYork.mat";  % all the RS's lat & lon
    ...
    params.infra.UE.configFile = "./config/UEInitNewYork.mat";  % all the UE's lat & lon
    ...
    %% map para
    params.map = struct();
    params.map.file = "./config/NewYork.osm";
